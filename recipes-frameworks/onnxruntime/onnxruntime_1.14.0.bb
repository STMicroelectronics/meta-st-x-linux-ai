...
SRC_URI += " file://1.14.0/0001-onnxruntime-test-remove-AVX-specific-micro-benchmark.patch "
SRC_URI += " file://1.14.0/0002-onnxruntime-add-SONAME-with-MAJOR-version.patch "
SRC_URI += " file://1.14.0/0003-onnxruntime-test-libcustom-library-remove-relative.patch "
SRC_URI += " file://1.14.0/0004-onnxruntime-fix-imcompatibility-with-compiler-GCC12.patch "
SRC_URI += " file://1.14.0/0005-onnxruntime-avoid-using-unsupported-Eigen-headers.patch "
SRC_URI += " file://1.14.0/0007-onnxruntime-cmake-change-visibility-compilation-opti.patch "
SRC_URI:append:stm32mp2common = " file://1.14.0/0006-onnxruntime-xnnpack-Fix-mcpu-compiler-build-failure.patch "
