...
SRC_URI += " file://coral_edgetpu_benchmark.cc;subdir=${BPN}-${PV} "
SRC_URI += " file://wrapper_coral.hpp;subdir=${BPN}-${PV} "
...
do_install() {
    ...
    install -m 0755 ${S}/coral_edgetpu_benchmark	${D}${prefix}/local/bin/coral-edgetpu-${PV}/tools
}

FILES:${PN} += "${prefix}/local/bin/coral-edgetpu-${PV}/tools/coral_edgetpu_benchmark"
