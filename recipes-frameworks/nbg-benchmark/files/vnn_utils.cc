...
/*
* Part of this code is inspired by code under License Apache-2.0 coming from
* https://github.com/IntelRealSense/RealSenseID/blob/v0.12.4/src/Matcher.cc
* with Copyright(c) 2020-2021 Intel Corporation. All Rights Reserved.
*/
