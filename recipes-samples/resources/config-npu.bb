...
SUMMARY = "Create package containing configuration file for X-LINUX-AI GPU/NPU version"
LICENSE = "SLA0044"
...
SRC_URI += "	file://resources-files/config_board_npu.sh \
...
do_install (){
	...
	install -m 0755 ${S}/resources-files/config_board_npu.sh    ${D}${prefix}/local/x-linux-ai/resources/
}

FILES:${PN} += "${prefix}/local/x-linux-ai/resources/"
RDEPENDS:${PN} += " bash "
RCONFLICTS:${PN} = "config-cpu"