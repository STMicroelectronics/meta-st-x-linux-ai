...
static void gui_create(CustomData *data)
{
	...
	if (data->preview_enabled)
		data->brain_icon = cairo_image_surface_create_from_png("/usr/local/demo-ai/computer-vision/armnn-tfl-image-classification/resources/ST7079_AI_neural_pink_65x80.png");
	else
		data->brain_icon = cairo_image_surface_create_from_png("/usr/local/demo-ai/computer-vision/armnn-tfl-image-classification/resources/ST7079_AI_neural_pink_65x80_next_inference.png");
	data->exit_icon = cairo_image_surface_create_from_png("/usr/local/demo-ai/computer-vision/armnn-tfl-image-classification/resources/close_50x50_pink.png");
