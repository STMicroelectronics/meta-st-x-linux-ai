...
SRC_URI  = " file://100-tflite-image-classification-python.yaml;subdir=${BPN}-${PV} "
SRC_URI += " file://101-tflite-image-classification-C++.yaml;subdir=${BPN}-${PV} "
SRC_URI += " file://resources/TensorFlowLite_C++.png;subdir=${BPN}-${PV} "
SRC_URI += " file://resources/TensorFlowLite_Python.png;subdir=${BPN}-${PV} "
SRC_URI += " file://applications/bin/label_tfl_gst_gtk.cc;subdir=${BPN}-${PV} "
...
SRC_URI += " file://applications/bin/launch_bin_label_tfl_mobilenet.sh;subdir=${BPN}-${PV} "
SRC_URI += " file://applications/bin/launch_bin_label_tfl_mobilenet_testdata.sh;subdir=${BPN}-${PV} "
SRC_URI += " file://applications/python/label_tfl_multiprocessing.py;subdir=${BPN}-${PV} "
SRC_URI += " file://applications/python/launch_python_label_tfl_mobilenet.sh;subdir=${BPN}-${PV} "
SRC_URI += " file://applications/python/launch_python_label_tfl_mobilenet_testdata.sh;subdir=${BPN}-${PV} "
