...
SRC_URI  = " file://110-tflite-object-detection-python.yaml;subdir=${BPN}-${PV} "
SRC_URI += " file://111-tflite-object-detection-C++.yaml;subdir=${BPN}-${PV} "
SRC_URI += " file://resources/TensorFlowLite_C++.png;subdir=${BPN}-${PV} "
SRC_URI += " file://resources/TensorFlowLite_Python.png;subdir=${BPN}-${PV} "
SRC_URI += " file://applications/bin/objdetect_tfl_gst_gtk.cc;subdir=${BPN}-${PV} "
SRC_URI += " file://applications/bin/wrapper_tfl.cc;subdir=${BPN}-${PV} "
SRC_URI += " file://applications/bin/wrapper_tfl.h;subdir=${BPN}-${PV} "
SRC_URI += " file://applications/bin/Makefile_objdetect;subdir=${BPN}-${PV} "
SRC_URI += " file://applications/bin/launch_bin_objdetect_tfl_coco_ssd_mobilenet.sh;subdir=${BPN}-${PV} "
SRC_URI += " file://applications/bin/launch_bin_objdetect_tfl_coco_ssd_mobilenet_testdata.sh;subdir=${BPN}-${PV} "
SRC_URI += " file://applications/python/objdetect_tfl_multiprocessing.py;subdir=${BPN}-${PV} "
SRC_URI += " file://applications/python/launch_python_objdetect_tfl_coco_ssd_mobilenet.sh;subdir=${BPN}-${PV} "
SRC_URI += " file://applications/python/launch_python_objdetect_tfl_coco_ssd_mobilenet_testdata.sh;subdir=${BPN}-${PV} "
