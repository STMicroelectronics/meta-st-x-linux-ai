...
struct tflite::wrapper_tfl::Label_Results results;
...
static void nn_inference(uint8_t *img, std::shared_ptr<edgetpu::EdgeTpuContext>* edgetpu_context)
{
	...
	tflite::wrapper_tfl::GetLabelResults(&config, interpreter, &results,edgetpu_context);
}
...
static void gui_create(CustomData *data)
{
	...
	if (data->preview_enabled)
		data->brain_icon = cairo_image_surface_create_from_png("/usr/local/demo-ai/computer-vision/tflite-image-classification-edgetpu/bin/resources/ST7079_AI_neural_pink_65x80.png");
	else
		data->brain_icon = cairo_image_surface_create_from_png("/usr/local/demo-ai/computer-vision/tflite-image-classification-edgetpu/bin/resources/ST7079_AI_neural_pink_65x80_next_inference.png");
	data->exit_icon = cairo_image_surface_create_from_png("/usr/local/demo-ai/computer-vision/tflite-image-classification-edgetpu/bin/resources/close_50x50_pink.png");
