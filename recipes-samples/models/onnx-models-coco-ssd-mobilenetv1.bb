...
SRC_URI = " file://detect.onnx \
            file://labels_detect_onnx.txt"
...
do_install() {
	...
	install -m 0644 ${S}/label*.txt    ${D}${prefix}/local/demo-ai/computer-vision/models/coco_ssd_mobilenet/labels_onnx.txt
	install -m 0644 ${S}/*.onnx        ${D}${prefix}/local/demo-ai/computer-vision/models/coco_ssd_mobilenet/
}
