...
SRC_URI = " http://storage.googleapis.com/download.tensorflow.org/models/tflite/coco_ssd_mobilenet_v1_1.0_quant_2018_06_29.zip;subdir=${BPN}-${PV}/coco_ssd_mobilenet_v1_1.0_quant;name=coco_ssd_mobilenet_v1_1.0_quant \
            ...
            file://ssd_mobilenet_v1_10_300_int8_edgetpu.tflite \
...
do_install() {
    ...
    install -m 0644 ${S}/ssd_mobilenet_v1_10_300_int8_edgetpu.tflite			    			                ${D}${prefix}/local/x-linux-ai//object-detection/models/coco_ssd_mobilenet/ssd_mobilenet_v1_10_300_edgetpu.tflite
}
